...
const outputPaths = ['./lib/utils/iconList.tsx', './public/assets/icons/icons.js'];
...
async function createIconObject() {
  try {
    ...
    await Promise.all(outputPaths.map(outputPath => fs.writeFile(outputPath, outputContent)));
  } catch (err) {
