    ...
    <footer className="idc-footer bg-idc-blue-700">
      <div className="px-6 py-6 idc-footer-details md:px-8 md:py-10">
        <Columns cols="1/3">
          ...
          <Columns.Content>
            <ul className="mb-2 font-light text-right text-white/90">
              <li>310 Beechgrove Avenue, Suite B, Ottawa, ON, Canada, K1Z 6R3</li>
            </ul>
            <ul className="inline-flex justify-end w-full gap-3 font-light divide-x divide-white/30 text-white/90">
              <li className="pl-3">
