    ...
    <footer className="idc-footer bg-idc-blue-700">
      <div className="px-6 py-6 idc-footer-details md:px-8 md:py-10">
        <div className="flex flex-col justify-between gap-4 md:flex-row">
          <div className="w-[124px] md:w-[155px] h-[40px] md:h-[50px] mx-auto md:mx-0">
            <svg
              className="flex-none idc-logo fill-white"
              fill="none"
          ...
          <div className="">
            <ul className="mb-1 text-sm font-light md:text-right text-white/90">
              <li>310 Beechgrove Avenue, Suite B, Ottawa, ON, Canada, K1Z 6R3</li>
            </ul>
            <ul className="justify-around w-full gap-4 text-sm font-light md:inline-flex md:divide-x md:justify-end md:divide-white/30 text-white/90">
              <li className="pl-3 first:pl-0">
