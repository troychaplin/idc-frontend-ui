...
export declare const Hero: (({ children, maxWidth, cols, bgType, }: HeroProps) => import("react/jsx-runtime").JSX.Element) & {
    Content: {
        ({ children, title, date, datePrefix, headerType, isCenter, }: import('./content').HeroContentProps): import("react/jsx-runtime").JSX.Element;
        displayName: string;
    };
    Media: {
        ({ children }: import('./media').HeroMediaProps): import("react/jsx-runtime").JSX.Element;
        displayName: string;
    };
};
export {};
